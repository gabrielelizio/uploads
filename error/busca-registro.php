...
<div class="pt-2"></div>
	...
	<h1 class="ls-title-intro ls-ico-close pl-5 text-center "> Processamento dos Arquivos / Impressão </h1>
	</div>
...
$sql = "SELECT * FROM pendente WHERE nome like '%$rastreio%' or proposito like '%$rastreio%' or email like '%$rastreio%' or telefone like '%$rastreio%' or cursos like '%$rastreio%' or qtdecopias like '%$rastreio%' or data_envio like '%$rastreio%'";
