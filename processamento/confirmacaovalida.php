...
?>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <p><b>Detalhes:</b></p>
        <p>---------------------------------------------------------------------------------</p>
        <p>Solicitante: <?php echo "$nome";?> </p>
        <p>Data: <?php echo "$datahora";?> </p>
        <p>Opção de impressão: <?php echo "$opcaoimpressao";?>  </p>
        <p>Propósito: <?php echo "$proposito";?></p>
        <p>Qtde. cópias:<?php echo "$qtdecopias";?></p>
        <p>Arquivo: <?php echo "$path_arq";?></p>
        <p>---------------------------------------------------------------------------------</p>
