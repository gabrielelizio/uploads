...
class Graph {
    ...
    var $doframe=true,$frame_color=array(0,0,0), $frame_weight=1;	// Frame around graph *BORDA da cor do FUNDO do Sistema Configuracao: array(255,249,235)*
    var $boxed=false, $box_color=array(0,0,0), $box_weight=1;		// Box around plot area
    var $doshadow=false,$shadow_width=4,$shadow_color=array(255,249,235);	// Shadow for graph
    ...
    var $plotarea_color=array(255,249,235);	// Plot area color
...
class Legend {
    ...
    var $shadow=false; // Shadow around legend "box". *default is TRUE* (Sombra em volta da caixa de Legendas. *o padrão é TRUE*)
    ...
    var $csimareas='';
//---------------
// CONSTRUCTOR (Método Construtor, deixar em branco)
    function Legend() {
	// Empty
    }
//---------------
// PUBLIC METHODS	(Métodos Públicos)
    ...
    function SetColor($aFontColor,$aColor='red') {
	...
	// Find out maximum width we need for legend box - Procura o tamanho máximo necessário para o tamanho da caixa de legenda.
	if( $this->layout==LEGEND_VERT )
