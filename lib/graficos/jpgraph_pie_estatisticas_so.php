...
// Ver:		$Id: jpgraph_pie.php,v 1.41 2003/01/30 15:08:09 aditus Exp $
//
...
class PiePlot {
	...
	"monitor"  => array(131,46,28,23,25,56,213,237,268,14,326,387,10,388),
	"sand"   => array(131,46,209,170,19,50,65,72,131,209,46,393));
    var $theme="monitor";
...
// PUBLIC METHODS	
	...
	$this->setslicecolors = array_reverse($aColors);
    }
	...
	if( $sum==0 )
	    JpGraphError::Raise("Nenhum voto foi computado!");
...
// CONSTRUCTOR
	...
	$this->posx=$width/2;
	$this->posy=$height/2;
	$this->SetColor(array(255,255,255)); // Aqui seta o fundo do gráfico		
    }
